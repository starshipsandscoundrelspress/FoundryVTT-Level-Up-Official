...
import HackingManeuverMapReducer from './reducers/HackingManeuverMapReducer';
...
export default class ActorDocument extends TJSDocument {
	...
	constructor(doc, options) {
		...
		this.#hackingManeuvers = this.embedded.create(Item, HackingManeuverMapReducer);
	...
	get hackingManeuvers() {
		return this.#hackingManeuvers;
	}
