...
import ManeuverFilterStore from '../stores/ManeuverFilterStore';

export default class HackingManeuverCompendiumSheet extends SvelteApplication {
    ...
    super(
      foundry.utils.mergeObject(options, {
        ...
        svelte: {
          ...
          props: {
            compendiumType: 'hackingManeuver',
